...
Массив - индексированный список элементов (числа, другие массивы, строки и так далее). Выглядядит это примерно так:
...
Благодаря этому приобритаются следующие особенности:

- можно легко и бысто найти необходимый элемент по индексу
